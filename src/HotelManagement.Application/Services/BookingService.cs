...
public class BookingService : IBookingService
{
    ...
    public async Task<IEnumerable<BookingResponseDTO>> GetAllAsync()
    {
        ...
        return bookings.Select(b => new BookingResponseDTO { Id = b.Id, CustomerId = b.CustomerId, RoomId = b.RoomId,
    ...
    public async Task<BookingResponseDTO?> GetByIdAsync(int id)
    {
        ...
        if (booking is null)
            return null;
        return new BookingResponseDTO { Id = booking.Id,
    ...
    public async Task<BookingResponseDTO> CreateAsync(CreateBookingDTO dto)
    {
        ...
        var booking =
            new Booking { CustomerId = dto.CustomerId,     RoomId = dto.RoomId,           CheckInDate = dto.CheckInDate,
                          CheckOutDate = dto.CheckOutDate, BookingDate = DateTime.UtcNow, Status = "Pending",
